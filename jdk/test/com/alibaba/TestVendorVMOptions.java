...
public class TestVendorVMOptions {
    public static void main(String[] args) throws Exception {
        ...
        // enable DRAGONWELL_JAVA_OPTIONS
        pb = createProcessBuilder();
        updateEnvironment(pb, "DRAGONWELL_JAVA_OPTIONS", "-XX:+UnlockExperimentalVMOptions -XX:+UseWisp2");
        outputAnalyzer = new OutputAnalyzer(pb.start());
        outputAnalyzer.shouldHaveExitValue(0);

        // enable invalid DRAGONWELL_JAVA_OPTIONS
        pb = createProcessBuilder();
        updateEnvironment(pb, "DRAGONWELL_JAVA_OPTIONS", "-XX:+UnlockExperimentalVMOptions -XX:+UseWisp3");
        outputAnalyzer = new OutputAnalyzer(pb.start());
        outputAnalyzer.shouldHaveExitValue(1);

        // enable JAVA_OPTIONS and DRAGONWELL_JAVA_TOOL_OPTIONS_JDK_ONLY
        pb = createProcessBuilder();
        updateEnvironment(pb, "JAVA_TOOL_OPTIONS", "-XX:+UnlockExperimentalVMOptions -XX:+UseWisp3");
